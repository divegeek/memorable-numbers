...
public class WordMapperTest {
    ...
    /**
     * By testing with a very small dictionary, we guarantee coverage of all of the
     * boundary cases that have to do with the "edges" of the dictionary.  Besides,
     * it's kind of cool that we can easily implement a binary counter.
     */
    @Test public void testIntMapping() {
        for (int i = 0; i < 256; ++i) {
     ...
     */
    @Test public void testIntegerMax() {
     ...
     */
    @Test public void testLongMapping() {
     ...
     */
    @Test public void testBigIntegerMapping() {
    ...
    /**
     * Standard dictionaries tests.  Just verify some known results, so the test breaks
     * if something changes the outputs.
     */
    @Test public void testStandardDictionaries() {
        mapper = new WordMapper(DefaultDictionary.LARGE);
